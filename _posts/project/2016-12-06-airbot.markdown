...
- airbot2.jpg
- airbot3.jpg
website: http://github.com/tanay-bits/airbot
---
AirBot - Mobile Robot Orientation Control on Frictionless Surface (Air Hockey Table)
-----------------
*Master's Final Project, Fall 2016 | Advisors: [Nicholas Marchuk](http://www.mccormick.northwestern.edu/research-faculty/directory/affiliated/marchuk-nicholas.html), [Dr. Jarvis Schultz](http://www.mccormick.northwestern.edu/research-faculty/directory/affiliated/schultz-jarvis.html)*
...
![sim1](http://i.imgur.com/H5E5pLg.png)
![sim2](http://i.imgur.com/vIvdU21.png)
...
![proto](http://i.imgur.com/1yq4Lil.png)
...
+  Now we have the spherical coordinates of each sensor, and we know the distances between them (depending on how we placed them on the robot), we can derive the cartesian coordinates via some trigonometry and optimization (source - [Indoor positional tracking using dual-axis rotating laser sweeps](http://ieeexplore.ieee.org/abstract/document/7520559/)).
